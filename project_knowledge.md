...
- Foundation warm-start retention, 2026-06-04 and simplification 2026-06-05: frontend Personal AI and foundation training use a progressive backbone schedule by default: full backbone frozen first, then later ConvNeXt stages unfreeze before full fine-tuning. Warm starts now come from native `SonnaEditor` slider-regression checkpoints only. Use `scripts/analyse_backbone_drift.py` after training to quantify whether foundation features were preserved.
